...
//
// A diff at this entrypoint names two refs within one repository, not two
// independent resources, which is why it carries refs rather than targets. The
// two targets a service-side diff compares live on ServiceDiffRequestPolicyInput
// instead.
type DiffReportPolicyInput struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Changes lists all dependency changes between the refs.
	//
	// The runtime binds deputy.diff.v1.PackageChange values here. This message
	// cannot declare that type, because deputy.diff.v1 imports this file and
	// naming it would close an import cycle, which is why the shape is restated
	// locally. Unifying the two is tracked in the diff_report binding issue.
	...
	// Vulnerabilities lists the findings the diff reported.
...
func (x *DiffReportPolicyInput) GetRepo() string {
	if x != nil {
		return x.Repo
	}
	return ""
...
func (x *DiffReportPolicyInput) GetBaseRef() string {
	if x != nil {
		return x.BaseRef
	}
	return ""
...
func (x *DiffReportPolicyInput) GetTargetRef() string {
	if x != nil {
		return x.TargetRef
	}
	return ""
...
func (x *DiffReportPolicyInput) GetVulnerabilities() []*v1.Finding {
	if x != nil {
		return x.Vulnerabilities
	}
	return nil
...
const file_deputy_policy_v1_policy_proto_rawDesc = "" +
	...
	"\x03env\x18\x02 \x01(\v2\x1d.deputy.policy.v1.EnvironmentR\x03env\x120\n" +
	"\x06target\x18\x03 \x01(\v2\x18.deputy.target.v1.TargetR\x06target\"\xc4\x02\n" +
	"\x15DiffReportPolicyInput\x12<\n" +
	"\achanges\x18\x01 \x03(\v2\".deputy.policy.v1.DependencyChangeR\achanges\x12/\n" +
	"\x03env\x18\x04 \x01(\v2\x1d.deputy.policy.v1.EnvironmentR\x03env\x12\x12\n" +
	"\x04repo\x18\x05 \x01(\tR\x04repo\x12\x19\n" +
	"\bbase_ref\x18\x06 \x01(\tR\abaseRef\x12\x1d\n" +
	"\n" +
	"target_ref\x18\a \x01(\tR\ttargetRef\x12J\n" +
	"\x0fvulnerabilities\x18\b \x03(\v2 .deputy.vulnerability.v1.FindingR\x0fvulnerabilitiesJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04R\tdiff_baseR\vdiff_target\"\xcb\x01\n" +
...
var file_deputy_policy_v1_policy_proto_depIdxs = []int32{
	...
	3,   // 46: deputy.policy.v1.DiffReportPolicyInput.env:type_name -> deputy.policy.v1.Environment
	63,  // 47: deputy.policy.v1.DiffReportPolicyInput.vulnerabilities:type_name -> deputy.vulnerability.v1.Finding
	64,  // 48: deputy.policy.v1.DependencyChange.pkg:type_name -> deputy.dependency.v1.Package
	16,  // 49: deputy.policy.v1.DiffDependencyChangePolicyInput.change:type_name -> deputy.policy.v1.DependencyChange
	3,   // 50: deputy.policy.v1.DiffDependencyChangePolicyInput.env:type_name -> deputy.policy.v1.Environment
	63,  // 51: deputy.policy.v1.DiffVulnerabilityPolicyInput.vulnerability:type_name -> deputy.vulnerability.v1.Finding
	3,   // 52: deputy.policy.v1.DiffVulnerabilityPolicyInput.env:type_name -> deputy.policy.v1.Environment
	20,  // 53: deputy.policy.v1.ContainerDiffReportPolicyInput.package_changes:type_name -> deputy.policy.v1.ContainerPackageChange
	21,  // 54: deputy.policy.v1.ContainerDiffReportPolicyInput.vulnerability_changes:type_name -> deputy.policy.v1.ContainerVulnerabilityChange
	22,  // 55: deputy.policy.v1.ContainerDiffReportPolicyInput.config_changes:type_name -> deputy.policy.v1.ContainerConfigDiff
	23,  // 56: deputy.policy.v1.ContainerDiffReportPolicyInput.base_image:type_name -> deputy.policy.v1.ContainerImageRef
	23,  // 57: deputy.policy.v1.ContainerDiffReportPolicyInput.target_image:type_name -> deputy.policy.v1.ContainerImageRef
	3,   // 58: deputy.policy.v1.ContainerDiffReportPolicyInput.env:type_name -> deputy.policy.v1.Environment
	68,  // 59: deputy.policy.v1.ContainerPackageChange.base_layer_details:type_name -> deputy.container.v1.LayerDetails
	68,  // 60: deputy.policy.v1.ContainerPackageChange.target_layer_details:type_name -> deputy.container.v1.LayerDetails
	20,  // 61: deputy.policy.v1.ContainerDiffChangePolicyInput.change:type_name -> deputy.policy.v1.ContainerPackageChange
	3,   // 62: deputy.policy.v1.ContainerDiffChangePolicyInput.env:type_name -> deputy.policy.v1.Environment
	21,  // 63: deputy.policy.v1.ContainerDiffVulnerabilityPolicyInput.vulnerability_change:type_name -> deputy.policy.v1.ContainerVulnerabilityChange
	3,   // 64: deputy.policy.v1.ContainerDiffVulnerabilityPolicyInput.env:type_name -> deputy.policy.v1.Environment
	27,  // 65: deputy.policy.v1.ContainerDiffLayerPolicyInput.layer_change:type_name -> deputy.policy.v1.LayerChange
	3,   // 66: deputy.policy.v1.ContainerDiffLayerPolicyInput.env:type_name -> deputy.policy.v1.Environment
	22,  // 67: deputy.policy.v1.ContainerDiffConfigPolicyInput.config_diff:type_name -> deputy.policy.v1.ContainerConfigDiff
	3,   // 68: deputy.policy.v1.ContainerDiffConfigPolicyInput.env:type_name -> deputy.policy.v1.Environment
	29,  // 69: deputy.policy.v1.SecretsReportPolicyInput.findings:type_name -> deputy.policy.v1.SecretFinding
	30,  // 70: deputy.policy.v1.SecretsReportPolicyInput.stats:type_name -> deputy.policy.v1.SecretStats
	3,   // 71: deputy.policy.v1.SecretsReportPolicyInput.env:type_name -> deputy.policy.v1.Environment
	65,  // 72: deputy.policy.v1.SecretsReportPolicyInput.target:type_name -> deputy.target.v1.Target
	29,  // 73: deputy.policy.v1.SecretsFindingPolicyInput.finding:type_name -> deputy.policy.v1.SecretFinding
	3,   // 74: deputy.policy.v1.SecretsFindingPolicyInput.env:type_name -> deputy.policy.v1.Environment
	34,  // 75: deputy.policy.v1.GraphReportPolicyInput.nodes:type_name -> deputy.policy.v1.GraphNode
	35,  // 76: deputy.policy.v1.GraphReportPolicyInput.edges:type_name -> deputy.policy.v1.GraphEdge
	36,  // 77: deputy.policy.v1.GraphReportPolicyInput.stats:type_name -> deputy.policy.v1.GraphStats
	3,   // 78: deputy.policy.v1.GraphReportPolicyInput.env:type_name -> deputy.policy.v1.Environment
	65,  // 79: deputy.policy.v1.GraphReportPolicyInput.target:type_name -> deputy.target.v1.Target
	63,  // 80: deputy.policy.v1.GraphNode.vulnerabilities:type_name -> deputy.vulnerability.v1.Finding
	59,  // 81: deputy.policy.v1.GraphStats.ecosystems:type_name -> deputy.policy.v1.GraphStats.EcosystemsEntry
	34,  // 82: deputy.policy.v1.GraphNodePolicyInput.node:type_name -> deputy.policy.v1.GraphNode
	3,   // 83: deputy.policy.v1.GraphNodePolicyInput.env:type_name -> deputy.policy.v1.Environment
	35,  // 84: deputy.policy.v1.GraphEdgePolicyInput.edge:type_name -> deputy.policy.v1.GraphEdge
	34,  // 85: deputy.policy.v1.GraphEdgePolicyInput.from_node:type_name -> deputy.policy.v1.GraphNode
	34,  // 86: deputy.policy.v1.GraphEdgePolicyInput.to_node:type_name -> deputy.policy.v1.GraphNode
	3,   // 87: deputy.policy.v1.GraphEdgePolicyInput.env:type_name -> deputy.policy.v1.Environment
	40,  // 88: deputy.policy.v1.FixPlanPolicyInput.commands:type_name -> deputy.policy.v1.RemediationCommand
	3,   // 89: deputy.policy.v1.FixPlanPolicyInput.env:type_name -> deputy.policy.v1.Environment
	65,  // 90: deputy.policy.v1.FixPlanPolicyInput.target:type_name -> deputy.target.v1.Target
	40,  // 91: deputy.policy.v1.FixPlanStepPolicyInput.step:type_name -> deputy.policy.v1.RemediationCommand
	3,   // 92: deputy.policy.v1.FixPlanStepPolicyInput.env:type_name -> deputy.policy.v1.Environment
	43,  // 93: deputy.policy.v1.TriageReportPolicyInput.top_packages:type_name -> deputy.policy.v1.TriagePackageSummary
	67,  // 94: deputy.policy.v1.TriageReportPolicyInput.stats:type_name -> deputy.vulnerability.v1.Stats
	3,   // 95: deputy.policy.v1.TriageReportPolicyInput.env:type_name -> deputy.policy.v1.Environment
	65,  // 96: deputy.policy.v1.TriageReportPolicyInput.target:type_name -> deputy.target.v1.Target
	43,  // 97: deputy.policy.v1.TriageClusterPolicyInput.cluster:type_name -> deputy.policy.v1.TriagePackageSummary
	3,   // 98: deputy.policy.v1.TriageClusterPolicyInput.env:type_name -> deputy.policy.v1.Environment
	46,  // 99: deputy.policy.v1.DockerfileReportPolicyInput.dockerfile:type_name -> deputy.policy.v1.DockerfileInfo
	49,  // 100: deputy.policy.v1.DockerfileReportPolicyInput.dockerfile_analysis:type_name -> deputy.policy.v1.DockerfileAnalysis
	3,   // 101: deputy.policy.v1.DockerfileReportPolicyInput.env:type_name -> deputy.policy.v1.Environment
	47,  // 102: deputy.policy.v1.DockerfileInfo.stages:type_name -> deputy.policy.v1.DockerfileStage
	47,  // 103: deputy.policy.v1.DockerfileInfo.final_stage:type_name -> deputy.policy.v1.DockerfileStage
	60,  // 104: deputy.policy.v1.DockerfileInfo.args:type_name -> deputy.policy.v1.DockerfileInfo.ArgsEntry
	48,  // 105: deputy.policy.v1.DockerfileStage.base_image_resolved:type_name -> deputy.policy.v1.ImageReference
	61,  // 106: deputy.policy.v1.DockerfileStage.env_vars:type_name -> deputy.policy.v1.DockerfileStage.EnvVarsEntry
	62,  // 107: deputy.policy.v1.DockerfileStage.labels:type_name -> deputy.policy.v1.DockerfileStage.LabelsEntry
	47,  // 108: deputy.policy.v1.DockerfileStagePolicyInput.stage:type_name -> deputy.policy.v1.DockerfileStage
	46,  // 109: deputy.policy.v1.DockerfileStagePolicyInput.dockerfile:type_name -> deputy.policy.v1.DockerfileInfo
	3,   // 110: deputy.policy.v1.DockerfileStagePolicyInput.env:type_name -> deputy.policy.v1.Environment
	4,   // 111: deputy.policy.v1.ServiceScanRequestPolicyInput.jwt:type_name -> deputy.policy.v1.JWTClaims
	51,  // 112: deputy.policy.v1.ServiceScanRequestPolicyInput.request:type_name -> deputy.policy.v1.ServiceRequest
	65,  // 113: deputy.policy.v1.ServiceScanRequestPolicyInput.target:type_name -> deputy.target.v1.Target
	3,   // 114: deputy.policy.v1.ServiceScanRequestPolicyInput.env:type_name -> deputy.policy.v1.Environment
	4,   // 115: deputy.policy.v1.ServiceListRequestPolicyInput.jwt:type_name -> deputy.policy.v1.JWTClaims
	51,  // 116: deputy.policy.v1.ServiceListRequestPolicyInput.request:type_name -> deputy.policy.v1.ServiceRequest
	65,  // 117: deputy.policy.v1.ServiceListRequestPolicyInput.target:type_name -> deputy.target.v1.Target
	3,   // 118: deputy.policy.v1.ServiceListRequestPolicyInput.env:type_name -> deputy.policy.v1.Environment
	4,   // 119: deputy.policy.v1.ServiceSbomRequestPolicyInput.jwt:type_name -> deputy.policy.v1.JWTClaims
	51,  // 120: deputy.policy.v1.ServiceSbomRequestPolicyInput.request:type_name -> deputy.policy.v1.ServiceRequest
	65,  // 121: deputy.policy.v1.ServiceSbomRequestPolicyInput.target:type_name -> deputy.target.v1.Target
	3,   // 122: deputy.policy.v1.ServiceSbomRequestPolicyInput.env:type_name -> deputy.policy.v1.Environment
	4,   // 123: deputy.policy.v1.ServiceDiffRequestPolicyInput.jwt:type_name -> deputy.policy.v1.JWTClaims
	51,  // 124: deputy.policy.v1.ServiceDiffRequestPolicyInput.request:type_name -> deputy.policy.v1.ServiceRequest
	65,  // 125: deputy.policy.v1.ServiceDiffRequestPolicyInput.diff_base:type_name -> deputy.target.v1.Target
	65,  // 126: deputy.policy.v1.ServiceDiffRequestPolicyInput.diff_target:type_name -> deputy.target.v1.Target
	3,   // 127: deputy.policy.v1.ServiceDiffRequestPolicyInput.env:type_name -> deputy.policy.v1.Environment
	4,   // 128: deputy.policy.v1.ServiceSecretsRequestPolicyInput.jwt:type_name -> deputy.policy.v1.JWTClaims
	51,  // 129: deputy.policy.v1.ServiceSecretsRequestPolicyInput.request:type_name -> deputy.policy.v1.ServiceRequest
	65,  // 130: deputy.policy.v1.ServiceSecretsRequestPolicyInput.target:type_name -> deputy.target.v1.Target
	3,   // 131: deputy.policy.v1.ServiceSecretsRequestPolicyInput.env:type_name -> deputy.policy.v1.Environment
	4,   // 132: deputy.policy.v1.ServiceGraphRequestPolicyInput.jwt:type_name -> deputy.policy.v1.JWTClaims
	51,  // 133: deputy.policy.v1.ServiceGraphRequestPolicyInput.request:type_name -> deputy.policy.v1.ServiceRequest
	65,  // 134: deputy.policy.v1.ServiceGraphRequestPolicyInput.target:type_name -> deputy.target.v1.Target
	3,   // 135: deputy.policy.v1.ServiceGraphRequestPolicyInput.env:type_name -> deputy.policy.v1.Environment
