...
// formatting, indentation, quotes, and unrelated comments. ctx is checked
// between reading the file and writing it back, so a caller that gave up
// mid-rewrite never finds the file changed.
//
