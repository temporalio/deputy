...
func TestAWSV1Integration(t *testing.T) {
	...
	vulns, err := QueryOSVBatch(ctx, client, []PkgInput{{Name: "github.com/aws/aws-sdk-go", Version: "1.55.6", IsDirect: true}})
	if err != nil {
	...
	vulns, err = QueryOSVBatch(ctx, client, []PkgInput{{Name: "github.com/aws/aws-sdk-go", Version: "1.33.0", IsDirect: true}})
	if err != nil {
