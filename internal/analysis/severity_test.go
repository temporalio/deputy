...
func TestEcosystemString(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.want, func(t *testing.T) {
			got := tt.eco.String()
			if got != tt.want {
				t.Errorf("Ecosystem.String() = %q, want %q", got, tt.want)
			}
		})
	}
}
...
func TestParseEcosystem(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			got := ParseEcosystem(tt.input)
			if got != tt.want {
				t.Errorf("ParseEcosystem(%q) = %v, want %v", tt.input, got, tt.want)
			}
		})
	}
}

func TestEcosystemRoundTrip(t *testing.T) {
	...
	for _, eco := range ecosystems {
		t.Run(eco.String(), func(t *testing.T) {
			str := eco.String()
			parsed := ParseEcosystem(str)
			if parsed != eco {
				t.Errorf("ParseEcosystem(%q) = %v, want %v", str, parsed, eco)
			}
		})
	}
}
