...
var (
	...
	styleSubsect  = lipgloss.NewStyle().Foreground(lipgloss.Color("#87CEEB"))              // StylePolicyFile
	...
	styleValue    = lipgloss.NewStyle().Foreground(lipgloss.Color("#CCCCCC"))            // StyleAliasOther
	...
	// Code/command style - aligned with StylePolicyFile (#87CEEB)
	styleCode = lipgloss.NewStyle().Foreground(lipgloss.Color("#87CEEB")).Background(lipgloss.Color("#1A1A1A"))
	styleFlag = lipgloss.NewStyle().Foreground(lipgloss.Color("#87CEEB"))
	...
	styleEcosystem = lipgloss.NewStyle().Foreground(lipgloss.Color("#7FDBFF")).Bold(true)  // StyleManager

	// Threat intelligence styles
	styleKEV     = lipgloss.NewStyle().Foreground(lipgloss.Color("#FF5555")).Bold(true) // StyleRemoved
	styleEPSS    = lipgloss.NewStyle().Foreground(lipgloss.Color("#FFD700"))            // StyleDowngraded
	...
	// Symbol styles
	styleSymbol     = lipgloss.NewStyle().Foreground(lipgloss.Color("#666666")) // StyleDim
	styleBullet     = lipgloss.NewStyle().Foreground(lipgloss.Color("#666666"))
	styleTreeBranch = lipgloss.NewStyle().Foreground(lipgloss.Color("#666666"))

	// Timeline styles
	styleDate     = lipgloss.NewStyle().Foreground(lipgloss.Color("#A9A9A9")) // StyleVersion
	styleRelative = lipgloss.NewStyle().Foreground(lipgloss.Color("#A0A0A0")).Italic(true)

	// CWE styles - purple for technical identifiers
	styleCWE     = lipgloss.NewStyle().Foreground(lipgloss.Color("#BB99FF"))
	styleCWEDesc = lipgloss.NewStyle().Foreground(lipgloss.Color("#A0A0A0")) // StyleMeta
