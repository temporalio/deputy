...
var variableMetadataByName = map[string]VariableMetadata{
	...
	"command":               {Type: "string", Description: "Command being evaluated"},
	...
	"context":               {Type: "object", Description: "Additional policy execution context"},
	...
	"requested_config":      {Type: "object", Description: "Requested sandbox configuration"},
	"roots":                 {Type: "list(string)", Description: "PURLs of direct (depth-0) dependencies"},
	"sandbox_config":        {Type: "object", Description: "Effective sandbox configuration"},
