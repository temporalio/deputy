...
//
//  1. Target Resolution ([github.com/temporalio/deputy/internal/targets/providers])
...
//
//  2. Image Configuration ([github.com/temporalio/deputy/internal/container/image])
...
//
//  3. Inventory Extraction ([github.com/temporalio/deputy/internal/inventory])
...
//
//  4. Vulnerability Analysis ([github.com/temporalio/deputy/internal/scanning])
//     - Queries OSV database for package vulnerabilities
//     - Attaches layer details to findings for provenance
//
//  5. Policy Evaluation ([github.com/temporalio/deputy/internal/policy])
//     - Evaluates CEL policies against image + vulnerabilities
//     - Variables: image, image_info, vulnerability.layerDetails
//
// # Subpackages
//
//   - [github.com/temporalio/deputy/internal/container/image] - Image configuration and metadata
//
// # Data Flow
//
